...
const SLIDE_INSIGHTS = [
    ...
    "Liability laundering. Hallucinated authority. Erasure. These aren't edge cases of GenAI in marketing—they are default bugs. If you don't intentionally design your system to catch them, your brand will ship them.",
